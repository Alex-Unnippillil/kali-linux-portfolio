...
- `RATE_LIMIT_SECRET` – authenticate rate-limit bypass checks issued from middleware/tests.
...
| `RATE_LIMIT_SECRET` | Shared secret used by middleware and tests to authenticate rate-limit bypass calls. |
