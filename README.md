...
- **`components/base/window.js`** - draggable, focusable window with header controls and overflow toggles (transparency, stickiness, notifications); integrates with desktop z-index.
