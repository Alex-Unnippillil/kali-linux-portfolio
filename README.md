...
### Requirements
- **Node.js 22.12.0** (repo includes `.nvmrc`; run `nvm use`)
- **Yarn** or **npm**
...
nvm install  # installs Node 22.12.0 from .nvmrc if needed
nvm use
yarn install
yarn dev
```
...
- Uses **Node 22.12.0** to match `package.json`.
...
- [x] **Pin Node to 22.12.0** across runtime and CI.
