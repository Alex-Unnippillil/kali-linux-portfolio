    ...
    extend: {
      ...
      colors: {
        ...
        kali: {
          ...
          blue: 'var(--kali-blue)',
          'blue-dark': 'var(--kali-blue-dark)',
          'blue-glow': 'var(--kali-blue-glow)',
          'bg-solid': 'var(--kali-bg-solid)',
          'terminal-green': 'var(--kali-terminal-green)',
          'terminal-text': 'var(--kali-terminal-text)',
        },
      },
      boxShadow: {
