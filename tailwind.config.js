...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      animation: {
        glow: 'glow calc(var(--motion-enabled) * 1s) ease-in-out infinite',
        flourish: 'flourish calc(var(--motion-enabled) * 0.6s) ease-out',
        mine: 'mine calc(var(--motion-enabled) * 0.4s) ease-in-out',
      },
      transitionDuration: {
        75: 'calc(var(--motion-enabled) * 75ms)',
        100: 'calc(var(--motion-enabled) * 100ms)',
        150: 'calc(var(--motion-enabled) * 150ms)',
        200: 'calc(var(--motion-enabled) * 200ms)',
        300: 'calc(var(--motion-enabled) * 300ms)',
        500: 'calc(var(--motion-enabled) * 500ms)',
        700: 'calc(var(--motion-enabled) * 700ms)',
        1000: 'calc(var(--motion-enabled) * 1000ms)',
      },
    },
  },
  plugins: [
