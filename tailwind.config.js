  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'window-chrome': 'var(--color-window-chrome)',
        'on-window-chrome': 'var(--color-window-chrome-text)',
        'status-success': 'var(--color-status-success)',
        'on-status-success': 'var(--color-on-status-success)',
        'status-info': 'var(--color-status-info)',
        'on-status-info': 'var(--color-on-status-info)',
        'status-warning': 'var(--color-status-warning)',
        'on-status-warning': 'var(--color-on-status-warning)',
        'status-danger': 'var(--color-status-danger)',
        'on-status-danger': 'var(--color-on-status-danger)',
