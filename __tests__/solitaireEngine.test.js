import { initializeGame, drawFromStock, moveTableauToTableau, moveWasteToTableau, moveToFoundation, autoMove, autoComplete, isWin, suits, createDeck, findHint, } from '../components/apps/solitaire/engine';
const card = (s, v, faceUp = true) => ({
    suit: s,
    value: v,
    color: s === '♠' || s === '♣' ? 'black' : 'red',
    faceUp,
