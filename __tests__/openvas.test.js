...
describe('OpenVASApp', () => {
  ...
  it('includes group in scan request', async () => {
    render(/*#__PURE__*/_jsx(OpenVASApp, {}));
    fireEvent.change(screen.getByPlaceholderText('Target (e.g. 192.168.1.1)'), {
      target: {
        value: '1.2.3.4'
      }
    });
    fireEvent.change(screen.getByPlaceholderText('Group (e.g. Servers)'), {
      target: {
        value: 'servers'
      }
    });
