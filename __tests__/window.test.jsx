...
describe('Window lifecycle', () => {
    it('invokes callbacks on close', () => {
        ...
        render(<Window id="test-window" title="Test" screen={() => <div>content</div>} focus={() => { }} hasMinimised={() => { }} closed={closed} hideSideBar={hideSideBar} openApp={() => { }}/>);
...
describe('Window snapping preview', () => {
    it('shows preview when dragged near left edge', () => {
        ...
        render(<Window id="test-window" title="Test" screen={() => <div>content</div>} focus={() => { }} hasMinimised={() => { }} closed={() => { }} hideSideBar={() => { }} openApp={() => { }} ref={ref}/>);
...
describe('Window snapping finalize and release', () => {
    ...
    it('releases snap with Alt+ArrowDown restoring size', () => {
        ...
        expect(ref.current.state.snapped).toBe('left');
        act(() => {
            ref.current.handleKeyDown({ key: 'ArrowDown', altKey: true });
        });
