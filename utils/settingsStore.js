...
export async function getShowAppMenu() {
  if (typeof window === 'undefined') return DEFAULT_SETTINGS.showAppMenu;
  const val = window.localStorage.getItem('show-app-menu');
  return val === null ? DEFAULT_SETTINGS.showAppMenu : val === 'true';
}

export async function setShowAppMenu(value) {
  if (typeof window === 'undefined') return;
  window.localStorage.setItem('show-app-menu', value ? 'true' : 'false');
}
...
export async function resetSettings() {
  ...
  window.localStorage.removeItem('show-app-menu');
}
...
export async function importSettings(json) {
  ...
  if (showAppMenu !== undefined) await setShowAppMenu(showAppMenu);
