...
export interface AboutContributionDay {
  date: string;
  count: number;
}
...
export interface AboutResume {
  ...
  experience: { date: string; description: string; tags: string[] }[];
}
...
export const aboutProfile: AboutProfile = {
  ...
  skillCategories: [
    {
      ...
      badges: [
        ...
        {
          src: 'https://img.shields.io/badge/Azure-%230072C6.svg?logo=microsoftazure&logoColor=white',
          alt: 'Azure',
          description: 'Microsoft Azure',
        },
        {
          src: 'https://img.shields.io/badge/Windows_Server-0078D6?logo=windows',
          alt: 'Windows Server',
          description: 'Windows Server Administration',
        },
        {
          src: 'https://img.shields.io/badge/Docker-2496ED?logo=docker&logoColor=fff',
          alt: 'Docker',
          description: 'Container Platform',
        },
        {
          src: 'https://img.shields.io/badge/Kubernetes-326CE5?logo=kubernetes&logoColor=fff',
          alt: 'Kubernetes',
          description: 'Container Orchestration',
        },
        {
          src: 'https://img.shields.io/badge/Tor-7D4698?logo=Tor-Browser&logoColor=white',
          alt: 'Tor',
          description: 'Anonymity Network',
        },
        {
          src: 'https://img.shields.io/badge/CCNA-007ACC?logo=Cisco&logoColor=fff',
          alt: 'CCNA',
          description: 'Cisco Certified Network Associate',
        },
        {
          src: 'https://img.shields.io/badge/CCNP-007ACC?logo=Cisco&logoColor=fff',
          alt: 'CCNP',
          description: 'Cisco Certified Network Professional',
        },
        {
          src: 'https://img.shields.io/badge/PuTTY-7D4698?logo=gnometerminal&logoColor=white',
          alt: 'PuTTY',
          description: 'SSH Client',
        },
        {
          src: 'https://img.shields.io/badge/Wireshark-%230072C6.svg?logo=wireshark&logoColor=white',
          alt: 'Wireshark',
          description: 'Network Analyzer',
        },
        {
          src: 'https://img.shields.io/badge/OWASP-black?style=flat&logo=OWASP&logoColor=ffffff',
          alt: 'OWASP',
          description: 'Open Web Application Security Project',
        },
        {
          src: 'https://img.shields.io/badge/Nmap-4682B4?logo=nmap&logoColor=white',
          alt: 'Nmap',
          description: 'Network Scanner',
        },
        {
          src: 'https://img.shields.io/badge/Metasploit-1280c4?logo=metasploit&logoColor=white',
          alt: 'Metasploit',
          description: 'Penetration Testing Framework',
        },
        {
          src: 'https://img.shields.io/badge/Burp_Suite-FF6633?logo=burp-suite&logoColor=white',
          alt: 'Burp Suite',
          description: 'Web Vulnerability Scanner',
        },
        {
          src: 'https://img.shields.io/badge/Splunk-000000?logo=splunk&logoColor=white',
          alt: 'Splunk',
          description: 'Security Information and Event Management',
        },
        {
          src: 'https://img.shields.io/badge/OpenVPN-F78F20?logo=openvpn&logoColor=white',
          alt: 'OpenVPN',
          description: 'VPN Solution',
        },
        {
          src: 'https://img.shields.io/badge/Nessus-00A0D1?logo=tenable&logoColor=white',
          alt: 'Nessus',
          description: 'Vulnerability Scanner',
        },
        {
          src: 'https://img.shields.io/badge/Snort-A40327?logo=snort&logoColor=white',
          alt: 'Snort',
    ...
    {
      id: 'softwaresOperating',
      title: 'Softwares & Operating Systems',
      badges: [
        {
          src: 'https://img.shields.io/badge/PowerShell-%235391FE.svg?logo=powershell&logoColor=white',
          alt: 'PowerShell',
          description: 'Automation Shell',
        },
        {
          src: 'https://img.shields.io/badge/-VMware-FFCA28?style=flat&logo=vmware&logoColor=ffffff',
          alt: 'VMware',
        ...
        {
          src: 'https://img.shields.io/badge/Fedora-51A2DA?logo=fedora&logoColor=fff',
          alt: 'Fedora',
          description: 'Fedora Linux',
        },
        {
          src: 'https://img.shields.io/badge/macOS-000000?logo=macos&logoColor=F0F0F0',
          alt: 'macOS',
        ...
        {
          src: 'https://img.shields.io/badge/Xcode-007ACC?logo=Xcode&logoColor=white',
          alt: 'Xcode',
        ...
        {
          src: 'https://img.shields.io/badge/Debian-D70A53?logo=debian&logoColor=white',
          alt: 'Debian',
        ...
        {
          src: 'https://img.shields.io/badge/VS%20Code-007ACC?logo=visual-studio-code&logoColor=white',
          alt: 'VS Code',
        ...
        {
          src: 'https://img.shields.io/badge/CentOS-262577?logo=CentOS&logoColor=white',
          alt: 'CentOS',
          description: 'CentOS Linux',
        },
        {
          src: 'https://img.shields.io/badge/Arch%20Linux-1793D1?logo=arch-linux&logoColor=white',
          alt: 'Arch Linux',
    ...
    },
    {
      ...
      badges: [
        ...
        {
          src: 'https://img.shields.io/badge/Rust-000000?logo=rust&logoColor=white',
          alt: 'Rust',
          description: 'Rust Programming Language',
        },
        {
          src: 'https://img.shields.io/badge/Bash-121011?logo=gnubash&logoColor=white',
          alt: 'Bash',
        ...
        {
          src: 'https://img.shields.io/badge/Swift-FA7343?logo=swift&logoColor=white',
          alt: 'Swift',
    ...
    },
    {
      ...
      badges: [
        ...
        {
          src: 'https://img.shields.io/badge/Hydrogen-7AB55C?logo=shopify&logoColor=fff',
          alt: 'Hydrogen',
          description: 'Shopify Framework',
        },
        {
          src: 'https://img.shields.io/badge/NIST-black?style=flat&logo=netapp&logoColor=ffffff',
          alt: 'NIST',
  ...
  milestones: [
    { year: '2020', description: 'Began cybersecurity journey' },
    {
      year: '2021',
      description: 'Completed first capture-the-flag competition',
    },
    {
      year: '2023',
      description: 'Built portfolio showcasing 20+ security projects',
    },
  ],
  badges: [
  ...
  projects: [
    ...
    },
    {
      ...
      description: [
        'Password Generator password tick menu of numbers, lowercase, uppercase and/or special characters strength of password metre',
      ],
      domains: ['python'],
    },
    {
    ...
    },
    {
      ...
      description: ['a dictionary of cyber security terms and their definitions'],
      domains: ['javascript'],
    },
    {
    ...
    },
    {
      ...
      description: [
        'text-translator utilizes the googletrans library to translate text from one language to another',
      ],
      domains: ['python'],
    },
    {
    ...
    },
    {
      ...
      description: ['AES encryption algorithm utilizes the cryptopp library'],
      domains: ['c++'],
    },
    {
      ...
      description: ['download the images from a website'],
      domains: ['python'],
    },
    {
      name: 'Binary Search',
      ...
      description: ['Binary Search w/ check sort, find min/max'],
      domains: ['c++'],
    },
    {
      name: 'AES-Python',
      ...
      description: ['AES encryption / decryption utilizing cryptography.fernet in python'],
      domains: ['python'],
    },
    {
      ...
      description: ['Generate a random password at a desired character length.'],
      domains: ['c++'],
    },
    {
      name: 'caesar-cipher',
      ...
      description: ['a simple python script that allows you to encrypt, decrypt and brute force strings'],
      domains: ['python'],
    },
    {
      name: 'Art-Generator',
      ...
      description: ['a art generator created in python and javascript'],
    ...
    },
    {
      ...
      description: ['59 Functions in Python'],
      domains: ['python'],
    },
    {
      ...
      description: ['Reaction Test Game'],
    ...
    },
    {
      ...
      description: ['A simple hangman game in python'],
      domains: ['python'],
    },
    {
      name: 'tictactoe',
      ...
      description: ['Tic Tac Toe Game in 100% HTML'],
      domains: ['html5'],
    },
    {
      ...
      description: ['simple blockchain iteration'],
      domains: ['python'],
    },
    {
  ...
  resume: {
    skills: ['Networking', 'Security', 'JavaScript', 'React'],
    projects: [
      {
        name: 'Text-Encryption-Decryption-AES-PKCS7',
        link: 'https://github.com/Alex-Unnippillil/Text-Encryption-Decryption-AES-PKCS7',
...
export const aboutSectionsById = new Map(
  aboutProfile.sections.map((section) => [section.id, section] as const)
);

export const aboutSkillCategoryMap = new Map(
  aboutProfile.skillCategories.map((category) => [category.id, category] as const)
);
