...
import {
  ...
  getShowAppMenu as loadShowAppMenu,
  setShowAppMenu as saveShowAppMenu,
  defaults,
...
interface SettingsContextValue {
  ...
  setShowAppMenu: (value: boolean) => void;
...
export const SettingsContext = createContext<SettingsContextValue>({
  ...
  showAppMenu: defaults.showAppMenu,
  theme: 'default',
  setAccent: () => {},
  setWallpaper: () => {},
  setDensity: () => {},
...
export function SettingsProvider({ children }: { children: ReactNode }) {
  ...
  const [showAppMenu, setShowAppMenu] = useState<boolean>(defaults.showAppMenu);
  ...
  useEffect(() => {
    (async () => {
      ...
      setShowAppMenu(await loadShowAppMenu());
      setTheme(loadTheme());
    })();
  }, []);
