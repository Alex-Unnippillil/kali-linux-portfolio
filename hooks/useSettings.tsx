...
import {
  ...
  getPseudoLocale as loadPseudoLocale,
  setPseudoLocale as savePseudoLocale,
  defaults,
...
interface SettingsContextValue {
  ...
  setPseudoLocale: (value: boolean) => void;
...
export const SettingsContext = createContext<SettingsContextValue>({
  ...
  pseudoLocale: defaults.pseudoLocale,
  theme: 'default',
  setAccent: () => {},
  setWallpaper: () => {},
  setUseKaliWallpaper: () => {},
...
export function SettingsProvider({ children }: { children: ReactNode }) {
  ...
  const [pseudoLocale, setPseudoLocale] = useState<boolean>(defaults.pseudoLocale);
  ...
  useEffect(() => {
    (async () => {
      ...
      setPseudoLocale(await loadPseudoLocale());
      setTheme(loadTheme());
    })();
  }, []);
