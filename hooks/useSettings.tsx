...
import {
  ...
  getEdgeSwitchDelay as loadEdgeSwitchDelay,
  setEdgeSwitchDelay as saveEdgeSwitchDelay,
  defaults,
...
interface SettingsContextValue {
  ...
  setEdgeSwitchDelay: (value: number) => void;
}
...
export const SettingsContext = createContext<SettingsContextValue>({
  ...
  theme: 'default',
  edgeSwitchDelay: defaults.edgeSwitchDelay,
  setAccent: () => {},
  setWallpaper: () => {},
  setDensity: () => {},
  setReducedMotion: () => {},
...
export function SettingsProvider({ children }: { children: ReactNode }) {
  ...
  const [edgeSwitchDelay, setEdgeSwitchDelay] = useState<number>(defaults.edgeSwitchDelay);
  ...
  useEffect(() => {
    (async () => {
      ...
      setEdgeSwitchDelay(await loadEdgeSwitchDelay());
      setTheme(loadTheme());
    })();
  }, []);
  ...
  useEffect(() => {
    saveEdgeSwitchDelay(edgeSwitchDelay);
  }, [edgeSwitchDelay]);
