      ...
      <div className="flex h-full w-full flex-col bg-ub-cool-grey text-white">
        <header className="flex flex-col gap-4 border-b border-gray-800 bg-black/30 p-4 backdrop-blur-sm lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex items-center gap-2 self-end text-gray-200 lg:self-start">
            <img src="/themes/Yaru/window/window-minimize-symbolic.svg" alt="minimize" className="h-6 w-6" />
            <img src="/themes/Yaru/window/window-close-symbolic.svg" alt="close" className="h-6 w-6" />
            <div>
