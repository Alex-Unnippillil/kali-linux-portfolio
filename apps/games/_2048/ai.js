import { cloneBoard, moveLeft, moveRight, moveUp, moveDown, boardsEqual } from './logic';
const MOVES = [
...
const expectimax = (board, depth, isPlayer) => {
    if (depth === 0)
...
export const findBestMove = (board, depth = 2) => {
    let bestDir = null;
