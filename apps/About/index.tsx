  ...
  return (
    <div className="min-h-screen w-full bg-[var(--kali-bg)]">
      <div className="mx-auto flex min-h-screen max-w-screen-md flex-col px-4 py-6 sm:px-6 sm:py-10">
        <header className="mb-10 rounded-xl border border-[var(--kali-border)] bg-[var(--kali-surface)] p-5 shadow-sm shadow-black/20 sm:p-7">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:gap-8">
            <div className="flex justify-center sm:flex-shrink-0">
              <Image
                ...
                width={128}
                height={128}
                className="h-32 w-32 rounded-full border border-[var(--kali-border)] bg-[var(--kali-overlay)] shadow-inner"
                priority
              />
            </div>
            <div className="flex-1 space-y-4 text-center sm:text-left">
              ...
              <nav className="flex justify-center gap-3 sm:justify-start" aria-label="Social profiles">
                <a
                  ...
                  aria-label="GitHub"
                  className="group inline-flex h-11 w-11 items-center justify-center rounded-full border border-[var(--kali-border)] bg-[var(--kali-overlay)] text-white transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--kali-control)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--kali-bg)] hover:border-[var(--kali-control)] hover:bg-[color-mix(in_srgb,var(--kali-control)_18%,transparent)] hover:text-[var(--kali-control)]"
                >
        ...
        <section aria-labelledby="about-highlights" className="mb-10">
          ...
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
            <article
              tabIndex={0}
              className="rounded-xl border border-[var(--kali-border)] bg-[var(--kali-surface)] p-5 shadow-sm shadow-black/10 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--kali-control)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--kali-bg)] hover:border-[var(--kali-control)] hover:bg-[var(--kali-overlay)] hover:shadow-black/30"
            ...
            >
              ...
              <div className="mt-4 space-y-3 text-gray-200">
                <a
                  ...
                  className="inline-flex items-center text-base font-medium text-[var(--kali-control)] transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--kali-control)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--kali-bg)] hover:text-[color-mix(in_srgb,var(--kali-control)_75%,transparent)]"
                >
