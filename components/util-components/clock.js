...
const Clock = ({
    ...
    const popoverNode = (
        <div
            ...
            aria-modal="false"
            aria-label="Calendar"
            className="fixed z-50 w-[20rem] origin-top-right overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-slate-900/95 via-slate-950/90 to-slate-950/95 p-4 text-sm text-white shadow-[var(--shadow-elevation-overlay)] ring-1 ring-cyan-300/20 backdrop-blur-2xl"
            style={popoverStyle}
        >
