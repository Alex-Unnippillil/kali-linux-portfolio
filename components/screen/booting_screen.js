    ...
    return (
        <div
            ...
            <Image
                ...
                src="/icons/256/status/kali-logo.svg"
            ...
            <div className="w-10 h-10 flex justify-center items-center rounded-full outline-none cursor-pointer" onClick={props.turnOn} >
                {(props.isShutDown
                    ? <div className="bg-white rounded-full flex justify-center items-center w-10 h-10 hover:bg-gray-300"><Image width={32} height={32} className="w-8" src="/icons/48/status/power-button.svg" alt="Power button" sizes="32px" priority/></div>
                    : <Image width={40} height={40} className={" w-10 " + (props.visible ? " animate-spin " : "")} src="/icons/48/status/process-working-symbolic.svg" alt="Kali boot indicator" sizes="40px" priority/>)}
            </div>
            <Image
                width={200}
                height={100}
                className="md:w-1/5 w-1/2"
                src="/icons/256/status/kali-wordmark.svg"
