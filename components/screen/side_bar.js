            ...
            <div className="relative">
                ...
                <div
                    className={
                        ...
                        " w-max py-0.5 px-1.5 absolute top-1 left-full ml-5 text-kali-light-grey text-opacity-90 text-sm bg-kali-grey bg-opacity-70 border-gray-400 border border-opacity-40 rounded-md"
                    }
                >
                    Show Applications
                </div>
