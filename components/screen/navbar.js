        ...
        renderRunningApps = () => {
                ...
                return (
                        <ul
                                ...
                                className="flex max-w-[40vw] items-center gap-2 overflow-x-auto rounded-md border border-white/10 px-2 py-1"
                                role="list"
                                aria-label="Open applications"
                                onDragOver={this.handleTaskbarDragOver}
                                onDrop={this.handleTaskbarDrop}
                                style={{
                                        backgroundColor: 'rgba(27, 34, 49, var(--taskbar-opacity))',
                ...
                render() {
                        ...
                        return (
                                ...
                                style={{
                                                ...
                                                backgroundColor: 'rgba(15, 23, 42, var(--taskbar-opacity))',
                                                backdropFilter: 'blur(var(--taskbar-blur))',
                                                WebkitBackdropFilter: 'blur(var(--taskbar-blur))',
                                        }}
                                >
