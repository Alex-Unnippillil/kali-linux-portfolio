...
export class Desktop extends Component {
    ...
    renderNameBar = () => {
        ...
        return (
            <div className="absolute rounded-xl top-1/2 left-1/2 text-center text-kali-text-primary font-light text-sm bg-kali-surface shadow-kali-window border border-kali-border-subtle/40 transform -translate-y-1/2 -translate-x-1/2 sm:w-96 w-3/4 z-50">
                <div className="w-full flex flex-col justify-around items-start pl-6 pb-8 pt-6">
                    <span>New folder name</span>
                    <input className="outline-none mt-5 px-1 w-10/12 context-menu-bg border-2 border-kali-border-accent rounded-lg py-0.5 bg-kali-background/60 text-kali-text-primary focus:ring-2 focus:ring-kali-accent-primary/60" id="folder-name-input" type="text" autoComplete="off" spellCheck={false} autoFocus={true} />
                </div>
                <div className="flex">
                    <button
                        type="button"
                        ...
                        className="w-1/2 px-4 py-2 border border-kali-border-subtle/60 border-r-0 hover:bg-kali-surface-muted/70 hover:border-kali-border-subtle/40"
                    >
                        Create
                    </button>
                    <button
                        ...
                        className="w-1/2 px-4 py-2 border border-kali-border-subtle/60 hover:bg-kali-surface-muted/70 hover:border-kali-border-subtle/40"
                    >
                        Cancel
                    </button>
                </div>
