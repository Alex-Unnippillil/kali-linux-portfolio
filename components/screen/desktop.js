...
export class Desktop extends Component {
    ...
    renderNameBar = () => {
        ...
        return (
            <div className="absolute rounded-md top-1/2 left-1/2 text-center text-white font-light text-sm bg-kali-cool-grey transform -translate-y-1/2 -translate-x-1/2 sm:w-96 w-3/4 z-50">
                ...
                <div className="flex">
                    <button
                        ...
                        className="w-1/2 px-4 py-2 border border-gray-900 border-opacity-50 border-r-0 hover:bg-kali-warm-grey hover:bg-opacity-10 hover:border-opacity-50"
                    >
                        Create
                    </button>
                    <button
                        ...
                        className="w-1/2 px-4 py-2 border border-gray-900 border-opacity-50 hover:bg-kali-warm-grey hover:bg-opacity-10 hover:border-opacity-50"
                    >
                        Cancel
                    </button>
                </div>
