...
const VolumeControl: React.FC<VolumeControlProps> = ({ className = "" }) => {
  ...
  return (
    ...
    >
      ...
      {open && (
        <div
          className="absolute bottom-full right-0 z-50 mb-2 min-w-[9rem] rounded-md border border-black border-opacity-30 bg-ub-cool-grey px-3 py-2 text-xs text-white shadow-kali-modal"
