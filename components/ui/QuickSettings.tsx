...
const QuickSettings = ({ open, id = 'quick-settings-panel' }: Props) => {
  ...
  return (
    <div
      ...
      aria-hidden={!open}
      className={`group/qs absolute top-9 right-3 w-[17.5rem] origin-top-right rounded-xl border border-white/10 bg-slate-950/90 p-4 text-xs text-slate-100 shadow-kali-modal backdrop-blur-lg transition-all duration-200 focus:outline-none ${
        isVisible
