...
const QuickSettings = ({ open, id = 'quick-settings-panel' }: Props) => {
  ...
  return (
    <div
      ...
      aria-hidden={!open}
      className={`group/qs desktop-panel-surface absolute top-9 right-3 w-[17.5rem] origin-top-right bg-slate-950/90 p-4 text-xs text-slate-100 backdrop-blur-lg transition-all duration-200 focus:outline-none ${
        isVisible
