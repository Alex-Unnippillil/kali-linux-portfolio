    ...
    return (
        ...
        >
            ...
            <a
                ...
                className="touch-target w-full block cursor-default hover:bg-gray-700 mb-2"
            >
            ...
            <button
                ...
                className="touch-target w-full text-left cursor-default hover:bg-gray-700 mb-2"
            >
