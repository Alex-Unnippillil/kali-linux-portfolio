...
function DesktopMenu(props) {
    ...
    return (
        ...
        >
            ...
            <Devider />
            <div role="menuitem" aria-label="Paste" aria-disabled="true" tabIndex={-1} className="w-full py-0.5 hover:bg-ub-warm-grey hover:bg-opacity-20 mb-1.5 text-gray-400">
                <span className="ml-5">Paste</span>
            </div>
            <Devider />
            <div role="menuitem" aria-label="Show Desktop in Files" aria-disabled="true" tabIndex={-1} className="w-full py-0.5 hover:bg-ub-warm-grey hover:bg-opacity-20 mb-1.5 text-gray-400">
            ...
            <Devider />
            <div role="menuitem" aria-label="Display Settings" aria-disabled="true" tabIndex={-1} className="w-full py-0.5 hover:bg-ub-warm-grey hover:bg-opacity-20 mb-1.5 text-gray-400">
