...
const KALI_ICON_MAP: Record<string, string> = {
  ...
  recent: '/themes/Kali/places/folder-recent.svg',
  'recent-files': '/themes/Kali/places/folder-recent.svg',
  'recently-used': '/themes/Kali/places/folder-recent.svg',
  starred: '/themes/Kali/places/folder-starred.svg',
  favorites: '/themes/Kali/places/folder-starred.svg',
  favourites: '/themes/Kali/places/folder-starred.svg',
  bookmarks: '/themes/Kali/places/folder-starred.svg',
