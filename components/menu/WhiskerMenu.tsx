    ...
    <div className="relative inline-flex">
      ...
      {isVisible && (
        <div
          ...
          className={`fixed z-[260] flex max-h-[100vh] w-[min(100vw-1.5rem,680px)] flex-col overflow-x-hidden overflow-y-auto rounded-xl border border-[#1f2a3a] bg-[#0b121c] text-white shadow-[0_20px_40px_rgba(0,0,0,0.45)] transition-all duration-200 ease-out sm:absolute sm:top-full sm:left-0 sm:mt-1 sm:w-[680px] sm:max-h-[550px] sm:flex-row sm:overflow-hidden ${
        ...
        >
          <div className="flex w-full max-h-[45vh] flex-col overflow-y-auto bg-gradient-to-b from-[#111c2b] via-[#101a27] to-[#0d1622] sm:max-h-[525px] sm:w-[260px] sm:overflow-visible">
          ...
          <div className="flex max-h-[55vh] flex-1 flex-col bg-[#0f1a29] sm:max-h-full">
