          ...
          >
            {this.props.resizable !== false && (
              <>
                ...
                <WindowCorner position="tl" resize={this.handleCornerResize} />
                <WindowCorner position="tr" resize={this.handleCornerResize} />
                <WindowCorner position="bl" resize={this.handleCornerResize} />
                <WindowCorner position="br" resize={this.handleCornerResize} />
              </>
            )}
            <WindowTopBar
...
export class WindowCorner extends Component {
  componentDidMount() {
    this.trpImg = new window.Image(0, 0);
    this.trpImg.src =
      "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";
  ...
  render() {
    ...
    return (
      <div
        className={`${styles.windowCorner} ${pos} absolute z-10`}
        onDragStart={(e) => {
          e.dataTransfer.setDragImage(this.trpImg, 0, 0);
        }}
        onDrag={this.props.resize}
