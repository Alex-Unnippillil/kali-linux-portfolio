        ...
        <div className="absolute select-none right-0 top-0 mt-1 mr-1 flex justify-center items-center h-11 min-w-[8.25rem]">
            {pipSupported && props.pip && (
                <button
                    ...
                    onClick={togglePin}
                >
                    <PinIcon className="h-4 w-4" size={16} aria-hidden />
                </button>
            )}
            <button
                type="button"
            ...
            >
                <MinimizeIcon className="h-4 w-4" size={16} aria-hidden />
            </button>
            {props.allowMaximize && (
                props.isMaximised
                    ? (
                        ...
                        >
                            <RestoreIcon className="h-4 w-4" size={16} aria-hidden />
                        </button>
                    ) : (
                        <button
                            type="button"
                            ...
                            onClick={props.maximize}
                        >
                            <MaximizeIcon className="h-4 w-4" size={16} aria-hidden />
                        </button>
                    )
            )}
            <button
                ...
                onClick={props.close}
            >
                <CloseIcon className="h-4 w-4" size={16} aria-hidden />
            </button>
        </div>
    )
}
