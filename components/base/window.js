        ...
        <div className="absolute select-none right-0 top-0 mt-1 mr-1 flex justify-center items-center h-11 min-w-[8.25rem]">
            {pipSupported && props.pip && (
                <button
                    ...
                    onClick={togglePin}
                >
                    <PinIcon className="h-4 w-4 inline" aria-hidden="true" />
                </button>
            )}
            <button
                type="button"
            ...
            >
                <MinimizeIcon className="h-4 w-4 inline" aria-hidden="true" />
            </button>
            {props.allowMaximize && (
                props.isMaximised
                    ? (
                        ...
                        >
                            <RestoreIcon className="h-4 w-4 inline" aria-hidden="true" />
                        </button>
                    ) : (
                        <button
                            type="button"
                            ...
                            onClick={props.maximize}
                        >
                            <MaximizeIcon className="h-4 w-4 inline" aria-hidden="true" />
                        </button>
                    )
            )}
            <button
                ...
                onClick={props.close}
            >
                <CloseSvg className="h-4 w-4 inline" aria-hidden="true" />
            </button>
        </div>
    )
}
