...
const HydraApp = () => {
  ...
  return (
    <div className="h-full w-full p-4 bg-kali-background text-kali-text overflow-auto">
      <div className="grid grid-cols-2 gap-1.5">
          ...
          {[
            ...
            <div
              ...
              className={`flex items-center p-2 rounded border border-kali-border cursor-pointer text-sm transition-colors ${
                service === m.value
                  ? 'bg-kali-primary text-kali-inverse shadow-[0_0_0_1px_rgba(255,255,255,0.15)]'
                  : 'bg-kali-surface/90 text-kali-text/80 hover:bg-kali-surface'
              }`}
            >
            ...
            {userLists.map((l) => (
              <li key={l.name} className="flex justify-between">
                ...
                <button
                  ...
                  className="text-[var(--game-color-danger)] transition-colors hover:text-[color-mix(in_srgb,var(--game-color-danger),transparent_20%)]"
                >
                  Remove
                </button>
              </li>
        ...
        <div className="col-span-2">
          ...
          <canvas
            ...
            height="100"
            role="img"
            aria-label="Password candidate distribution"
            className="bg-kali-muted mt-2 w-full"
          ></canvas>
        </div>
        <div className="col-span-2 flex flex-wrap gap-1.5 mt-2">
          <button
            ...
            className="px-4 py-2 rounded bg-kali-terminal text-kali-inverse transition-colors hover:bg-kali-terminal/90 disabled:opacity-50"
          >
          ...
          <button
            onClick={dryRunHydra}
            disabled={running}
            className="px-4 py-2 rounded bg-kali-accent text-kali-inverse transition-colors hover:bg-kali-accent/90 disabled:opacity-50"
          >
            Dry Run
          </button>
          <button
            onClick={handleSaveConfig}
            className="px-4 py-2 rounded bg-kali-muted text-kali-text transition-colors hover:bg-kali-surface"
          >
            Save Config
          </button>
          <button
          ...
          {running && !paused && (
            <button
              ...
              onClick={pauseHydra}
              className="px-4 py-2 rounded bg-[var(--game-color-warning)] text-black transition-colors hover:bg-[color-mix(in_srgb,var(--game-color-warning),transparent_15%)]"
            >
              Pause
            </button>
          )}
          {running && paused && (
            <button
              ...
              onClick={resumeHydra}
              className="px-4 py-2 rounded bg-kali-primary text-kali-inverse transition-colors hover:bg-kali-primary/90"
            >
              Resume
            </button>
          )}
          {running && (
            <button
              ...
              onClick={cancelHydra}
              className="px-4 py-2 rounded bg-[var(--game-color-danger)] text-white transition-colors hover:bg-[color-mix(in_srgb,var(--game-color-danger),transparent_10%)]"
            >
              Cancel
            </button>
          )}
      ...
      {timeline.length > 0 && (
        <table className="mt-4 w-full text-sm">
          ...
          <tbody>
            {timeline.map((t, idx) => (
              <tr key={idx} className="border-t border-kali-border">
      ...
      <p className="mt-4 text-sm text-kali-text/80">
      ...
      {output && (
        <pre className="mt-4 bg-kali-dark p-2 overflow-auto h-64 whitespace-pre-wrap font-mono">{output}</pre>
      )}
      {showSaved && (
        <div className="fixed bottom-4 right-4 bg-kali-terminal text-kali-inverse px-3 py-1 rounded text-sm shadow-[0_0_18px_rgba(69,255,154,0.35)]">
          Saved
        </div>
      )}
    </div>
