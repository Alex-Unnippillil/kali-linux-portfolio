            ...
            >
              ...
              >
                <div className="flex items-center justify-between">
                  <span
                    dangerouslySetInnerHTML={{ __html: createTrustedHTML(escapeHtml(f.description)) }}
                  />
      ...
      {selected && (
        ...
        >
          <div className="bg-gray-800 p-4 rounded max-w-md w-full">
            ...
            <p
              className="mb-2"
              dangerouslySetInnerHTML={{ __html: createTrustedHTML(escapeHtml(selected.description)) }}
            />
