...
const GameLayout = ({ gameId = 'unknown', children, stage, lives, score, highScore, }) => {
    ...
    return (<div className="relative h-full w-full" data-reduced-motion={prefersReducedMotion}>
      ...
      <button type="button" aria-label="Help" aria-expanded={showHelp} onClick={toggle} className="absolute top-2 right-2 z-40 bg-gray-700 text-white rounded-full w-8 h-8 flex items-center justify-center focus:outline-none focus:ring">
        ?
      </button>
      {children}
