...
export function Settings() {
    ...
    return (
        <div className={"w-full flex-col flex-grow z-20 max-h-full overflow-y-auto windowMainScreen select-none bg-ub-cool-grey"}>
            ...
            <div className="flex justify-center my-4">
                <label className="mr-2 text-ubt-grey">Workspace Switch Delay (ms):</label>
                <input
                    type="number"
                    min="100"
                    max="2000"
                    step="50"
                    value={edgeSwitchDelay}
                    onChange={(e) => setEdgeSwitchDelay(parseInt(e.target.value) || 0)}
                    className="bg-ub-cool-grey text-ubt-grey px-2 py-1 rounded border border-ubt-cool-grey w-24"
                />
            </div>
            <div className="flex justify-center my-4">
                <div
