            ...
            <input
                ...
                onChange={async (e) => {
                    ...
                    try {
                        ...
                        if (parsed.taskbarAutoHide !== undefined) setTaskbarAutoHide(parsed.taskbarAutoHide);
                    } catch (err) {
