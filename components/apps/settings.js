            ...
            <div className="flex justify-center my-4">
                <label className="mr-2 text-ubt-grey flex items-center">
                    <input
                        type="checkbox"
                        checked={showAppMenu}
                        onChange={(e) => setShowAppMenu(e.target.checked)}
                        className="mr-2"
                    />
                    Show Applications submenu
                </label>
            </div>
            <div className="flex justify-center my-4">
                <label className="mr-2 text-ubt-grey flex items-center">
