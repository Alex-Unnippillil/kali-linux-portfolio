    ...
    return (
        <div className="w-full flex-col flex-grow z-20 max-h-full overflow-y-auto windowMainScreen select-none bg-kali-surface text-kali-text">
            <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 py-6">
                <header
                    className="flex flex-col gap-4 rounded-2xl border border-kali-border/60 bg-kali-surface-raised px-6 py-6 shadow-sm backdrop-blur-sm"
                    style={{
                        backgroundImage: `radial-gradient(circle at top left, ${accentGlow}, transparent 65%)`,
                    }}
                >
                    <div className="flex flex-wrap items-start justify-between gap-4">
                        ...
                        <div className="flex w-full flex-col items-start gap-2 sm:w-auto sm:items-end">
                            ...
                            <input
                                ...
                                className="w-full rounded-lg border border-kali-border/60 bg-kali-surface-muted px-3 py-2 text-sm text-kali-text/90 placeholder:text-kali-text/50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-kali-focus sm:w-64"
                            />
                        </div>
                    </div>
                    <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
                        <button
                            ...
                            className="w-full rounded-lg bg-kali-primary px-4 py-2 text-sm font-medium text-kali-inverse transition-colors hover:bg-kali-primary/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-kali-focus sm:w-auto"
                        >
                            Export
                        </button>
                        <button
                            onClick={() => fileInput.current && fileInput.current.click()}
                            className="w-full rounded-lg bg-kali-surface-muted px-4 py-2 text-sm font-medium text-kali-text/80 transition-colors hover:bg-kali-surface-raised focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-kali-focus sm:w-auto"
                        >
                            Import
                        </button>
                        <button
                            ...
                            className="w-full rounded-lg border border-kali-border/60 bg-kali-surface-muted px-4 py-2 text-sm font-medium text-kali-text/80 transition-colors hover:border-kali-focus/60 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-kali-focus sm:w-auto"
                        >
                            Reset
                        </button>
                        <button
                    ...
                    <div className="grid gap-3 text-xs text-kali-text/70 sm:grid-cols-3">
                        <div className="rounded-xl border border-kali-border/60 bg-kali-surface-muted px-3 py-2">
                            <p className="uppercase tracking-wide text-kali-text/50">Current theme</p>
                            <p className="text-sm text-kali-text">{theme}</p>
                        </div>
                        <div className="rounded-xl border border-kali-border/60 bg-kali-surface-muted px-3 py-2">
                            <p className="uppercase tracking-wide text-kali-text/50">Density</p>
                            <p className="text-sm text-kali-text">{density}</p>
                        </div>
                        <div className="rounded-xl border border-kali-border/60 bg-kali-surface-muted px-3 py-2">
                            <p className="uppercase tracking-wide text-kali-text/50">Accessibility</p>
                            <p className="text-sm text-kali-text">
                                {highContrast ? 'High contrast' : 'Standard'} · {reducedMotion ? 'Low motion' : 'Full motion'}
                            </p>
                        </div>
                    </div>
                </header>
                            ...
                            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
                                {WALLPAPERS.map((name) => (
                                    <button
                                        ...
                                        className={`group outline-none transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-kali-focus ${
                                            name === wallpaper
                                    ...
                                    >
                                        <div className="relative">
                                            ...
                                            />
                                            <div className="pointer-events-none absolute inset-0 rounded bg-black/10 opacity-0 transition group-hover:opacity-100" />
                                            {name === wallpaper && (
                                                <span className="absolute left-2 top-2 rounded-full bg-kali-primary/90 px-2 py-0.5 text-[10px] uppercase tracking-wide text-kali-inverse">
                                                    Active
                                                </span>
                                            )}
                                        </div>
