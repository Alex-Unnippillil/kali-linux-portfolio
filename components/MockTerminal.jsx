...
const MockTerminal = () => {
    ...
    return (<div ref={containerRef} tabIndex={0} className="bg-black text-green-400 font-mono p-4 h-48 overflow-y-auto outline-none focus:ring-2 focus:ring-green-500" aria-label="Mock terminal">
      {logs.map((log, idx) => (<div key={idx}>
