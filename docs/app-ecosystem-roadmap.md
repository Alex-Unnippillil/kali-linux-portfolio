...
| project-gallery | Project Gallery | Core maintainers | **Ready** – uses `data/projects.json` with stack/tag filters and accessible repo/demo CTAs | `projects.json` data |
