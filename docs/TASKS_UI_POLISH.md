...
59. **`<SEO/Meta>` audit**
   - **Accept:** Titles, descriptions, canonical, Open Graph images for desktop and key apps; JSON‑LD for Person, Portfolio, and SoftwareApplication data sets.
   - **Where:** `components/SEO/Meta.tsx`.
