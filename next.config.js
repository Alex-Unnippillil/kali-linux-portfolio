...
const ContentSecurityPolicy = [
  ...
  // Allow outbound connections for embeds and the in-browser Firefox app
  ...
  // Allow iframes from specific providers so the Firefox and StackBlitz apps can load allowed content
