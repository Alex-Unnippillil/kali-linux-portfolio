  ...
  return (
    <button
      ...
      className={`relative w-12 h-6 rounded-full transition-colors duration-200 focus:outline-none ${
        checked ? 'bg-kali-light-blue' : 'bg-kali-light-grey'
      }`}
    >
      <span
...
export default function ThemeSettings() {
  ...
  return (
    <div className="flex h-full">
      <nav className="w-48 p-4 border-r border-kali-light-cool-grey text-sm">
        <ul className="space-y-1.5">
          <li>
            <a className="flex items-center gap-2 p-2 rounded-l-md border-l-2 border-kali-light-blue bg-kali-cool-grey">
              <span className="w-6 h-6 bg-kali-light-grey rounded"></span>
              <span>Theme</span>
            </a>
          </li>
        </ul>
      ...
      <div className="flex-1 p-4 overflow-y-auto">
        ...
        <div className="mt-6">
          ...
          <div className="flex gap-2 p-2 bg-kali-cool-grey rounded">
            <div
              className="bg-kali-light-grey rounded"
        ...
        <div className="mt-6">
          ...
          <div className="grid grid-cols-2 gap-2 p-2 bg-kali-cool-grey rounded">
            {[1, 2, 3, 4].map((n) => (
              <div
                key={n}
                className="bg-kali-light-grey rounded"
