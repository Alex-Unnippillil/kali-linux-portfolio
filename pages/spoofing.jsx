...
const ToolTile = ({ title, link, children }) => (<a href={link} target="_blank" rel="noopener noreferrer" className="block p-4 bg-ub-grey text-white rounded shadow hover:bg-black focus:outline-none focus:ring">
    <h2 className="text-xl mb-2">{title}</h2>
    {children}
    <p className="mt-2 underline text-sm">Documentation</p>
  </a>);
const ArpDiagram = () => (<svg viewBox="0 0 300 120" className="w-full h-32">
    <defs>
...
const DnsDiagram = () => (<svg viewBox="0 0 300 160" className="w-full h-40">
    <defs>
