...
function AssistiveLayer({ children }) {
  const { assistiveTech } = useSettings();
  useEffect(() => {
    if (!assistiveTech) return;
    ...
    const handleAnnounce = (e) => update(e.detail);
    ...
    if (OriginalNotification) {
      ...
      Object.defineProperty(WrappedNotification, 'permission', { get: () => OriginalNotification.permission });
  ...
  return (
    <>
      ...
      {assistiveTech && <div aria-live="polite" id="live-region" />}
      {children}
    </>
  );
}
